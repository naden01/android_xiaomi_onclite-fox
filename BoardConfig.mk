...
$(error "Kernel image file not found: $(BOARD_PREBUILT_DTBOIMAGE)")
endif
# Kernel - DTBO
...
$(error "DTBO image file not found: $(BOARD_PREBUILT_DTBOIMAGE)")
endif
...
BOARD_SUPER_PARTITION_SIZE := 10480549888
...
BOARD_SUPER_PARTITION_CUST_DEVICE_SIZE := 408436736
BOARD_XIAOMI_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor system_ext product
BOARD_XIAOMI_DYNAMIC_PARTITIONS_SIZE := 10476355584 # (BOARD_SUPER_PARTITION_SIZE - 4MB)
